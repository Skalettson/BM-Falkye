...
/**
 * Партикл ледяного эффекта (использует стандартные текстуры)
 */
public class FrostEffectParticle extends TextureSheetParticle {
    protected FrostEffectParticle(ClientLevel level, double x, double y, double z, 
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, 
            ...
            return new FrostEffectParticle(level, x, y, z, xd, yd, zd, this.sprites);
        }
    }
}
